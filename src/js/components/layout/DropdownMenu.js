    ...
    render() {
        return (
            <li className="row dropdown">
                <a href="#" className="hidden-xs btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{this.props.buttonName}</a>
